...
<style>
  ...
  .custom-bg:hover{
    ...
    border-color: color rgb(37, 37, 37);
  }*/
      .availability-form{
        margin-top:-50p;
        z-index: 2;
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="d-flex">
        ...
        <button type="button" class="btn btn-outline-dark shadow-none me-lg-3 me-2" data-bs-toggle="modal" data-bs-target="#loginModal"id="btn">
          login
   </button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
     <form action="">
      <div class="modal-header">
        <h5 class="modal-title d-flex align-items-center">
          <i class="bi bi-person-circle fs-3 me-2"></i> User Regisrtration</h5>
        <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
    <div class="modal-body">
...
<div class="swiper mySwiper">
      <div class="swiper-wrapper">
        ...
        <img src="images/vishal1.jpg" />
        </div>
        <div class="swiper-slide">
        <img src="images/vishal2.jpg" class="w-100 d-block"/>
        </div>
        <div class="swiper-slide">
        <img src="images/vishal3.jpg" />
        </div>
        <div class="swiper-slide">
        <img src="images/vishal1.jpg" />
        </div>
...
<h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">Our Rooms</h2>
  ...
  <!-- Room no-1 -->
   <div class="row">
    ...
    <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
        <img src="images/vishal2.jpg" class="card-img-top">
 ...
 <div class="container">
  <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
    <div class="col-lg-2 col-mb-2 text-center bg-white rounded shadow py-4 my-3">
      ...
      <div class="swiper-wrapper mb-5">
        ...
        <div class="profile d-flex align-items-center p-4">
         ...
         <h6 class="m-0 ms-2">random user1</h6>
           ...
           <p> 
            ...
            Deleniti maxime quaerat sequi dicta enim ducimus expedita vero sit repudiandae
            sapiente perspiciatis fugit accusamus, aliquam tempore illo sed, quia saepe non!
           </p>
           <div class="rating">
           <i class="bi bi-star-fill text-warning"></i>
           <i class="bi bi-star-fill text-warning"></i>
       ...
       <div class="swiper-slide bg-white p-4">
         ...
         <h6 class="m-0 ms-2">random user1</h6>
           ...
           <p> 
            hi am vishal maulkar this website is 
            amazing and beatiful webframwork ghf ytr ytgf joh
             ase bv nf hf ur.
           </p>
           <div class="rating">
           <i class="bi bi-star-fill text-warning"></i>
 ...
 <!--
  <div class="container-fluid bg-white mt-5">
    <div class="row">
      ...
      <p>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit.
         Assumenda animi nesciunt, cum non provident, obcaecati illum atque,
         incidunt soluta veniam tempore nihil at odio debitis explicabo.
         Nulla deserunt modi nobis.
      </p>
    </div>
    <div class="col-lg-4">
     <h5 class=mb-3> Links</h5>
     <a href="#" class="d-inline block mb-2 text-decoration-dark text-decoration-none">Home</a> <br>
     <a href="#" class="d-inline block mb-2 text-decoration-dark text-decoration-none">Rooms</a><br>
     <a href="#" class="d-inline block mb-2 text-decoration-dark text-decoration-none">Facilities</a><br>
     <a href="#" class="d-inline block mb-2 text-decoration-dark text-decoration-none">Cantact us</a><br>
     <a href="#" class="d-inline block mb-2 text-decoration-dark text-decoration-none">About</a>
    </div>
    <div class="col-lg-4">
      <h5>Follow us</h5>
